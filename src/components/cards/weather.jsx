...
import p6 from '../../assets/images/weather-dashboard.png';

const WeatherDashboard = () => {
  return (
    <div className="project-card max-w-lg mx-auto overflow-hidden bg-white rounded-lg shadow-md">
      <img src={p6} alt="" className="w-full h-64 object-cover object-top" />
      <div className="p-6">
        <h3 className="project-title text-xl font-semibold text-gray-800">Weather Dashboard</h3>
        <p className="project-description mt-2 text-sm text-gray-600">The Weather Dashboard project offers users a user-friendly and visually appealing way to access and visualize weather information for different cities, making it easier to plan and prepare for various weather conditions.</p>
        <div className="project-technologies flex flex-wrap mt-3">
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 mt-2 px-2.5 py-0.5 rounded">API</span>
        </div>
